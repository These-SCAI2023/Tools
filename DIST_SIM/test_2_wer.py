...
# res_txt_propre = lire_fichier("./data/AUDOUX_PP/Audoux_PP_align_point_350.txt")
# hypothese_ocr = lire_fichier("./data_ocr/AUDOUX_OCR/Audoux_OCR_align_point_350.txt")
res_txt_propre = lire_fichier("./data/AIMARD_PP/Aimard_PP_align_point_400.txt")
hypothese_ocr = lire_fichier("./data/AIMARD_OCR/Aimard_OCR_align_point_400.txt")
