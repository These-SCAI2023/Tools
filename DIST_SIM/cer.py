...
res_txt_propre = lire_fichier("./data/AUDOUX_PP/Audoux_PP_align_point_350_alignement3000.txt")
hypothese_ocr = lire_fichier("./data_ocr/AUDOUX_OCR/Audoux_OCR_align_point_350_alignement3000.txt")
